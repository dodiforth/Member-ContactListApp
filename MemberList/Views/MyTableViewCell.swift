...
class MyTableViewCell: UITableViewCell {
    ...
    var memeber: Member? {
        didSet {
            guard var memeber = memeber else { return }
            mainImageView.image = memeber.memberImage
            memberNameLabel.text = memeber.name
            addressLabel.text = memeber.address
        }
    }
    ...
    func setupStackView() {
        ...
        // put stackview on cell
        self.addSubview(stackView)
        
        // put views on stackview
